...
=== 「CLIP 潜在性を用いた階層的テキスト条件付き画像生成法」の理解
...
私自身は知能システム科学で博士を取得しましたが、紹介するのは最新の研究です。用語の翻訳や解釈が間違っていたらごめんなさい。

==== Diffusion モデルと関連する専門用語

解説を通して専門用語がいくつか出てきます。
このあとの急速な進化が予感される「AIで絵を描く技術」、特に Stable Diffusion で覚えておきたい用語は「CLIP」と「Diffusionモデル」、そして「GLIDE」でしょうか。
一つ一つ簡単な言葉で説明していきたいと思います。
