...
//image[StableDiffusion_Pixiv20220905][筆者の pixiv アクセス状況。みなさまにご高覧頂き本当に感謝です！]
...
いいプロンプトがあれば参考にする、上手に描いた事例があれば『どんなプロンプトを書いたのだろう？』と検証する。
これは今までの漫画やイラストの世界の技術で「描く技術を盗む」そのマインドと何ら変わらないかもしれません。
...
//quote{
Stable Diffisuionで描いた絵を pixiv にアップロードした瞬間に画風を見抜いておすすめタグを提案してくるんだけど、潜在変数とエンコーダとデコーダーの合間で絵を描いている感はんぱない。
//}

たまに pixiv にアップロードした直後の推定タグで「オリジナル作品」が表示されるととても嬉しくなります。
いったいもう、どこの空間で絵を描いているのかわからなくなってきますね。
沢山のAI神絵師が登場し、高品質の絵を見せつけられ続ける中で、モチベーションを高く維持し続けられるもののみがその街道を走り続けられるのでしょう。
...
またメディア芸術史的な視点で Stable Diffusion を観察すると、日本のマンガ、アニメーションやゲームイラストに出てくるモチーフは、比較的記号化が進んでしまう要素であるという体感もあります。
...
つまり「AIが美しい絵を描くなら人類は絵を学ばなくていいか」という命題は、「学ぶ必要がある」ということであり、もはや Python を用いた数学や統計学も芸術の一端をになっているかもしれません。
...
もともと著作権法では、一定の｢例外的｣な場合に著作権等を制限して、著作権者等に許諾を得ることなく利用できることを定めています（第30条〜第47条の8）。
...
私は写真からバーチャルリアリティに入った人間なのですが、そういえば印象派画派は写真機の誕生によって生まれているという美術史観もあります。
...
しかし、ここからデジタルカメラまで一足飛びに行くのではなく「写真」というメディアが誕生したころから今ののスマートフォンのカメラに至るまで、それはもう大変な技術競争があったのです。

そして写真機の誕生という技術革新があった19世紀、印象派画家は写真から新たな創作意欲を刺激されたています。
もしかすると写真機の登場によって肖像画を描く市場価値は大きく下がっていたのかもしれません。
...
写真機も、絵具そのものも同時期のイノベーションによって生まれているのです。


=== Photogenicを追い求める脳がたどり着く未来の人類
さて、科学史から人類の「絵を描くこと」と技術の関係を紹介してみました。ところでここ数日、AI神絵師として実験を行っている間、描き手、クリエイターとしての感覚として、自分の画力や筋力（気合の入った絵を何時間も高速に描き続けるには筋力が必要です）に関係なく、新しいスタイルの発見や、上手な出力ができるようになると「脳が発火している」を感じました。
...
これはフォトグラファーであった頃の自分が感じていたパッション、フォトジェニック；photogenic（写真映えする）を追い求める脳とほぼ同じだと思います。
「この瞬間の美をとらえたい」「表現したい」「他の人に伝えたい」、「もっとすごい表現をする人がいる」そのサイクルがある限り、この「AI画像生成で美しい絵を作る」というサイクルは人類にとって意味を持つように思います。

後の人類にとっては「当たり前だよね？？」という話になると思います。

人工知能とともに絵を描くという行為が人類にどんな影響を与えているか、そして「人類は働きたいのか？」の結論として、
おそらくStableDiffusionによって、人類と「美しい絵を描く」という行為との関係には少しだけ変化が表れてくると思います。
それは前述のとおり、技術の革新であり、表現や道具が「誰でも使える」という状態によって現れるパラダイムシフトです。
しかし、そもそも全人類が絵を描きたかったのでしょうか？「人類は働きたいのか？」という問いにしたのですが、それは「AIが仕事を奪う」という概念がどこかにあるのではないでしょうか？

しかし、どうでしょう？例えば皆さんはスポーツクラブのようなところで運動をしませんか？労働や運動のように「自分からの努力で無駄なエネルギーを消費する」という行為は何故行っているのでしょうか？気晴らし？筋力の向上？余った脂肪や糖分などのエネルギーの消費が目的？なんだか『人はなぜ遊ぶのか』を探求する「遊びの理論」そっくりの話ではありませんか。
...
そして人々、特に子供でもお年寄りでも、クリエイティブな嗜好を持った人類は趣味として Stable Diffusion のようなAIに対して、様々な言葉を投げかけ、その対話の中から、「もっと言葉を学ぶべきだ」「表現を学ぶべきだ」「いや、私は自分で鉛筆をもって描きたい」といった自我に目覚めていくのだと思います。そこには自身の自我と美的感覚への探求が必ず存在するのです。

人類のやることはまだまだありそうです。
そして人工知能で絵を描く以外にも、作文を書くツールなども生まれています。
そう、この原稿も、ツールで書いているかもしれません！

……と書きつつ、手で執筆しています。
最後の最後まで、1文字1文字を人間の目で見て手で直しています。
人間は最後の最後まで、がんばってしまう存在なんだと思います。

そして最後の最後まで脱稿できてなくてごめんなさい＞部員各位。

//image[HMDcoverArts][VR関係の同人誌の表紙に使えそうな画像を生成してみた]
