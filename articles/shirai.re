...
晴れの翌日は40％で貼れ、40％で曇り、20％で雨、といった確率で変化し、曇り→雨、雨→曇りなど全てのとりうる状態が確率で表現できて、前日より前の天気には依存しないとするとします。
...
//image[StableDiffusion_Figma][実際しないフィギュア「Chibi Zombie Fighters」]{
//}
...
中々おもむき深いグラフィックデザインが生成されました。
どんなプロンプトを与えられるかについては、考古学的知識が必要ですし、やはり生み出されたノイズ画像から、目的の画像をゴールとして取り出すのは、我々人類なのです。
そしてそれが本当なのかどうか、真偽性はともかく、人々にとってどんな魅力や意味を持つのか…我々人類は、メディアと芸術に対して、より真剣に考えていく機会を得た感じがします。


=== レタッチテクニック

理想を言えばAI生成一発で、そのまま pixiv に投稿できるといいのですが、運に任せるよりは、少しでも見込みがある画像が生成されたら保存してレタッチをしたほうが良いと思います。
...
技術的には DALL-E2の生成画像編集や img2img 等を使って画像から教え込んであげる、といった方法がありますが、
お手軽には PhotoShopを使って消してあげるのが良いと思います。
...
ここは人間の絵師らしく、詩的なタイトルをつけましょう。

例えば金曜ロードショー「耳をすませば」を見ながら描いた「帰ってこないあのひと」、「雫はバイオリンを奏でたい」、難しい表情が表現できた「ちょっとこわいけど怖くない」、「まどろみ」、「ひるねするおくさん」などなど。

また、スタイルだけが作品になる場合は「無題」、「習作」などが雰囲気が出ます。
...
例えば「ミク x ガンダムコラボ」が需要あることはわかりました。
...
（本原稿執筆時点で前述のまだ炎上がやむ気配がないので観測ですが……）日本では、平成30年(2018)月18日に成立した改正著作権法第30条4項において
「著作物に表現された思想又は感情を自ら享受し又は他人に享受させることを目的としない場合には，その必要と認められる限度において，権利者の利益を通常害さないと評価できる」となっています。

 * 文化庁による解説 https://www.bunka.go.jp/seisaku/chosakuken/hokaisei/h30_hokaisei/

「例えば人工知能の開発のための学習用データとして著作物をデータベースに記録する行為など、広く著作物に表現された思想又は感情の享受を目的としない行為等を権利者の許諾なく行えることとなるものと考えられます」と具体的に記載されています。

著作人格権として「使っていいよ」という事になっているならなおさらですね。

そしてAIと著作権の話をするなら、プロとしてはまず、経産省の「AIデータ利用ガイドライン」、それから、著作人格権について説明できるようになってから他人に絡んでほしいかなと思います。

 * AI・データの利用に関する契約ガイドライン 1.1版（経済産業省） https://www.meti.go.jp/press/2019/12/20191209001/20191209001.html


=== 人類にとってAI神絵師とは何なのか

問題は「上手い」とか「下手」とか、人間は美醜に対して真剣になればなるほど「美しさに対して不寛容である」という点です。
ソロで描いているだけであれば、描いている本人がよければそれでいいのですが、SNS時代においては、
...
私は写真からバーチャルリアリティに入った人間なのですが、そういえば印象派画家は写真機の誕生によって生まれているという背景もありますね。
...
その19世紀、印象派画家は写真から新たな創作意欲を刺激されたています。
画家たちは、それまでのようにスタジオに籠ってランプの光で歴史的な絵画や肖像画を製作するのではなく、日常的なモチーフを屋外に出て自然光の下で絵を描くことに興味を持ち始めます。ただし当時の画家たちはパレット上で顔料と油を混ぜて絵の具を作ってから製作に取り掛かる必要があったため、スタジオの外で絵を描くことは実質的に不可能でした。
1841年にチューブ絵の具が発明されなければ、ルノワールは「チューブ絵の具が発明されなかったら印象派も生まれなかった」と言っているそうです。

人類のやることはまだまだありそうです。
そして人工知能で絵を描く以外にも、作文を書くツールなども生まれています。この原稿も、ツールで書いているかもしれません（最後の最後まで脱稿できてなくてごめんなさい＞部員各位）。
